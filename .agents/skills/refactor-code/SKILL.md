...
The `/refactor-code` skill performs safe, controlled code refactoring. It focuses on improving maintainability, reducing cognitive complexity, and eliminating technical debt without altering public API contracts or introducing unrequested features.
...
- **Decouple Dependencies:** Align implementation with clean architecture standards in [`.agents/standards/coding-standards.md`](file:///Users/ka8kgj/Documents/Source/RWD.Ai.Stack/.agents/standards/coding-standards.md).
...
2. **Document Architectural Changes**:
   - If the refactor introduces structural changes, record them in [`.agents/memory/PROJECT_CONTEXT.md`](file:///Users/ka8kgj/Documents/Source/RWD.Ai.Stack/.agents/memory/PROJECT_CONTEXT.md).
3. **Summary**:
