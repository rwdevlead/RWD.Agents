...
The `/commit-cleanup` skill performs a low-risk pre-commit sweep. It ensures debug logging, dead code, and formatting inconsistencies are resolved, and updates session memory state before committing code to git.
