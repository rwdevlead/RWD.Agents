...
The `/generate-docs` skill synchronizes project documentation, README files, API specs, and inline code comments with the current implementation.
...
2. **Check Documentation Standards**:
   - Review [`.agents/standards/documentation-standards.md`](file:///Users/ka8kgj/Documents/Source/RWD.Ai.Stack/.agents/standards/documentation-standards.md) for Markdown formatting and structure rules.
   - Review [`.agents/standards/code-documentation-standards.md`](file:///Users/ka8kgj/Documents/Source/RWD.Ai.Stack/.agents/standards/code-documentation-standards.md) for docstring and inline comment standards.
